...
public class RecurrentTravel {
	...
	private List<RecurrentBooking> bookings = new ArrayList<RecurrentBooking>();
	...
	public RecurrentTravel() {
		super();
		// TODO Auto-generated constructor stub
	}

	public RecurrentTravel(Zone from, Zone to, long when, Itinerary route,
			String userId, Recurrency recurrency, int places,
			boolean intermediateStops, List<RecurrentBooking> bookings,
			boolean active, List<String> communityIds, long lastInstance) {
		super();
		this.from = from;
		this.to = to;
		this.when = when;
	...
	public List<RecurrentBooking> getBookings() {
		return bookings;
	}

	public void setBookings(List<RecurrentBooking> bookings) {
		this.bookings = bookings;
	}
